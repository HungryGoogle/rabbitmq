...
import com.example.rabbitmq.mqcallback.MsgSendConfirmCallBack;
import com.example.rabbitmq.mqcallback.MsgSendReturnCallback;
...
public class RabbitMqConfig {
     ...
     * 队列hello
     */
    public static final String ROUTINGKEY3 = "queue_hello";
     ...
     */
    @Bean
    public Binding binding_hello() {
        return BindingBuilder.bind(queueConfig.helloQueue()).to(exchangeConfig.directExchange()).with(RabbitMqConfig.ROUTINGKEY3);
    }
